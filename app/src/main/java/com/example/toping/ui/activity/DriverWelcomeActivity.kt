...
import kotlinx.android.synthetic.main.activity_driver_welcome.*
...
class DriverWelcomeActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnDriverLoginNow.setOnClickListener {
            val intent = Intent(this, DriverPhoneNumberActivity::class.java)
