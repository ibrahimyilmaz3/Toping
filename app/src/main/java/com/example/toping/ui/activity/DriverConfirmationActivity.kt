...
import kotlinx.android.synthetic.main.activity_driver_confirmation.*

class DriverConfirmationActivity : BaseAppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnContinueMainDriver.setOnClickListener {
            funClearIntent(DriverProfileActivity())
        }

        val str1 = "Onay kodunuz "
        val str2 = "+90 " + Phone.number2
