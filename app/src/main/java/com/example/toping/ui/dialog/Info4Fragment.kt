...
class Info4Fragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "İletiniz bize ulaştı! En kısa sürede incelenecektir!"
    ...
    private fun funClearIntent(activity: Activity) {
