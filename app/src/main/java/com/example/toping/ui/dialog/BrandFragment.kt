...
import com.example.toping.adapter.BrandAdapter
...
class BrandFragment : DialogFragment() {

    private val brand = ArrayList<Brand>()
    private val adapter = BrandAdapter(brand)
    ...
    override fun onCreateView(
        ...
        view.tvHeadingDialog.text = "Araç markasını seçin"
    ...
    private fun dataInitialize() {
        brand.add(Brand("Volvo"))
        brand.add(Brand("Mercedes"))
        brand.add(Brand("Renault"))
        brand.add(Brand("Opel"))
        brand.add(Brand("Volvo"))
        brand.add(Brand("Mercedes"))
        brand.add(Brand("Renault"))
        brand.add(Brand("Opel"))
