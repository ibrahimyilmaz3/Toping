...
import com.example.toping.ui.activity.Detail3Activity
...
class Request2Adapter(private val request: ArrayList<Request>) :
            ...
            when (request[position].type) {
                ...
                "Tur" -> {
                    ...
                    btnDetail_tour2.setOnClickListener {
                        val intent = Intent(context, Detail3Activity::class.java)
