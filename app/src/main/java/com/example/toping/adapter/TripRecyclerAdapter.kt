...
import com.example.toping.ui.activity.TripDetailActivity

class TripRecyclerAdapter: RecyclerView.Adapter<TripRecyclerAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TripRecyclerAdapter.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.item_trips, parent, false)
        context = parent.context
        return  ViewHolder(v)
    }

    override fun onBindViewHolder(holder: TripRecyclerAdapter.ViewHolder, position: Int) {

        holder.cardMainTrips.setOnClickListener {
            val intent = Intent(context as AppCompatActivity, TripDetailActivity::class.java)
